...
import fr.cubiccl.generator3.game.object.type.blocks.*;
...
public final class Blocks112
{
	...
	public static final Block Planks = new Block(5, "planks");
	...
	static
	{
		...
		SlabDoubleStone.unusedDamage.addAll(Arrays.asList(10, 11, 12, 13, 14));
		...
		torch(RedstoneTorch);
		button(ButtonStone);
		SnowLayer.addBlockState(new BlockState("layers", BlockState.INTEGER, 1, "1", "2", "3", "4", "5", "6", "7", "8"));
		...
		Hopper.addBlockState(new BlockState("facing", BlockState.STRING, new int[]
		{ 0, 2, 3, 4, 5 }, "down", "north", "south", "west", "east"));
		Hopper.addBlockState(new BlockState("enabled", BlockState.BOOLEAN, 8, "true", "false"));
	...
	{
		block.addBlockState(new BlockState(state, BlockState.BOOLEAN, damage, "true", "false"));
	}
	...
	{
		variant(block, "oak", "spruce", "birch", "jungle");
		block.addBlockState(new BlockState("axis", BlockState.STRING, 4, "y", "x", "z", "none"));
	}

	private static void mushroom(Block block)
	{
		block.setTextureType(-1);
		block.addBlockState(new BlockState("variant", BlockState.STRING, new int[]
	...
	public static void numbered(Block block, String id, int damage, int maxValue)
	{
		...
		block.addBlockState(new BlockState(id, BlockState.INTEGER, 1, values));
	}
	...
	{
		block.addBlockState(new BlockState("facing", BlockState.STRING, new int[]
		{ 1, 2, 3, 4, 5 }, "east", "west", "south", "north", "up"));
	}
	...
	{
		block.addBlockState(new BlockState(id, BlockState.STRING, variants));
	}
